  ...
  return (
    <header className="sticky top-0 flex w-full z-[99] 
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6 relative z-10">
        ...
        <div className="flex items-center justify-between w-full px-6 pt-6 pb-6 lg:hidden">
          {/* SIAPUS Logo Text */}
        ...
        <div className="hidden lg:flex items-center justify-between w-full py-4 lg:justify-normal">
          <button
        ...
        <div className="hidden lg:flex items-center justify-end w-full gap-4 px-5 py-4 lg:px-0 lg:shadow-none">
...
const InstallAppButton = () => {
    ...
    return (
        <button
            onClick={install}
            className="flex items-center justify-center text-gray-700 transition-colors bg-white border border-gray-200 rounded-full h-9 w-9 hover:bg-gray-100 hover:text-brand-500 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:text-white"
            title="Install App"
        >
