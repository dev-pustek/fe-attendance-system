      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute bottom-8 left-6 z-30">
          <button
            ...
            className="p-3 bg-black/50 hover:bg-black/70 rounded-full text-white transition-colors backdrop-blur-md border border-white/10 active:scale-95 shadow-lg"
            title="Switch Camera"
          >
