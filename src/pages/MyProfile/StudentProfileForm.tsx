  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        const profile = await profilesService.getStudent(user.public_id);
        ...
        setFormData({
          ...
          entryYear: profile.entryYear || new Date().getFullYear(),
          enrollmentDate: profile.enrollmentDate?.split("T")[0] || "",
          studentStatus: profile.studentStatus || "ACTIVE",
          pipRecipient: profile.pipRecipient || false,
          kipNumber: profile.kipNumber || "",
          notes: profile.notes || "",
                ...
                <div className="space-y-1.5">
                  <NumberInput
                    ...
                    onChange={(val) =>
                      setFormData((prev) => ({
                        ...prev,
                        entryYear: val ? parseInt(String(val), 10) : undefined,
                      }))
                    }
                    maxLength={4}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  <PhoneNumberInput
                    ...
                    onChange={(val) =>
                      setFormData((prev) => ({ ...prev, fatherPhone: val }))
                    }
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  <PhoneNumberInput
                    ...
                    onChange={(val) =>
                      setFormData((prev) => ({ ...prev, motherPhone: val }))
                    }
                  />
                </div>
              </div>
