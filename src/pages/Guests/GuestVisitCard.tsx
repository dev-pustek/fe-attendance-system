    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col p-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col">
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white line-clamp-1">{visit.guest?.name || "Tidak Diketahui"}</h3>
                        <span className="text-sm text-gray-500 line-clamp-1 mt-0.5">{visit.guest?.company || "Kunjungan Pribadi"}</span>
                    </div>
                </div>
                ...
                <div className="mt-4 flex flex-col gap-2">
                    ...
                    {(visit.checkOut || visit.checkOutTime) && (
                        <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 p-2 rounded-lg dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.05]">
                            <span className="block uppercase tracking-wider text-[10px] opacity-70 mb-0.5">Sudah Check-Out</span>
            ...
            <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50/30 px-4 py-2 sm:px-5 dark:border-white/[0.05] dark:bg-white/[0.01]">
                <div className="text-xs text-gray-500 font-medium">Aksi</div>
